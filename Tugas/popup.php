                ...
                <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                    ...
                    <span aria-hidden="true">&times;</span>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6 ">
                                    <img src="img/produk/vakumLaptop.jpg" width="300px">
                                </div>
                                <div class="col-md-6 ">
                ...
                <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                    ...
                    <span aria-hidden="true">&times;</span>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6 ">
                                    <img src="img/produk/headphone.jpg" width="300px">
                                </div>
                                <div class="col-md-6 ">
                                    <table class="table table-borderless">
                                        <tr>
                ...
                <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                    ...
                    <span aria-hidden="true">&times;</span>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6 ">
                                    <img src="img/produk/mouseGaming.jpg" width="300px">
                                </div>
                                <div class="col-md-6 ">
                                    <table class="table table-borderless">
                                        <tr>
                ...
                <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                    ...
                    <span aria-hidden="true">&times;</span>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6 ">
                                    <img src="img/produk/terminalUsb.jpg" width="300px">
                                </div>
                                <div class="col-md-6 ">
                                    <table class="table table-borderless">
                                        <tr>
                ...
                <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                    ...
                    <span aria-hidden="true">&times;</span>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6 ">
                                    <img src="img/produk/printer.jpg" width="300px">
                                </div>
                                <div class="col-md-6 ">
                                    <table class="table table-borderless">
                                        <tr>
                ...
                <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                    ...
                    <span aria-hidden="true">&times;</span>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6 ">
                                    <img src="img/produk/ups.jpg" width="300px">
                                </div>
                                <div class="col-md-6 ">
                                    <table class="table table-borderless">
                                        <tr>
                ...
                <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                    ...
                    <span aria-hidden="true">&times;</span>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6 ">
                                    <img src="img/produk/lcd.jpg" width="300px">
                                </div>
                                <div class="col-md-6 ">
                                    <table class="table table-borderless">
                                        <tr>
                ...
                <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                    ...
                    <span aria-hidden="true">&times;</span>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6 ">
                                    <img src="img/produk/cctv.jpg" width="300px">
                                </div>
                                <div class="col-md-6 ">
                                    <table class="table table-borderless">
                                        <tr>
